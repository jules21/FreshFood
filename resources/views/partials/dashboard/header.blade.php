<div class="topbar">
    ...
    <div class="topbar-left"><a href="index.html" class="logo">
       <span>
          <span class="text-white">FreshFood</span>
         </span><i><img src="{{asset('dashboard/assets/images/logo-sm.png')}}" alt="" height="22"></i></a>
      </div>
       ...
       <ul class="navbar-right d-flex list-inline float-right mb-0">
          ...
          <li class="dropdown notification-list">
             <div class="dropdown notification-list nav-pro-img">
                <a class="dropdown-toggle nav-link arrow-none waves-effect nav-user" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false"><img src="{{asset('dashboard/assets/images/users/user-4.jpg')}}" alt="user" class="rounded-circle"></a>
